            ...
            <section style={{ padding: '80px 0' }}>
                <div className="container" style={{ maxWidth: '780px' }}>
                    ...
                    <div style={sectionStyle}>
                        ...
                        <p style={textStyle}>
                            Noore Jewels is an online fashion jewellery brand specialising in premium American
                            Diamond (AD) and Cubic Zirconia (CZ) imitation jewellery. Our products are <strong>not
                                real diamonds or precious stones</strong> — they are high-quality imitation/fashion jewellery
                            designed to give you a luxurious look at affordable prices.
                        </p>
                        <p style={textStyle}>
                            All product descriptions, images, and materials mentioned on the website are for
                            imitation jewellery only. By purchasing from us, you acknowledge that you are
                            buying fashion/imitation jewellery.
                        </p>
                    </div>
