                    ...
                    <div className="footer-v2-grid">
                        ...
                        <div className="footer-v2-brand-col">
                            ...
                            <div className="footer-v2-socials">
                                ...
                                <a href="https://wa.me/919217945235" target="_blank" rel="noopener noreferrer" className="footer-v2-social" title="WhatsApp">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div>
                            ...
                            <ul className="footer-v2-links">
                                ...
                                <li>
                                    <a href="https://wa.me/919217945235?text=Hi! I need help" target="_blank" rel="noopener noreferrer">
                                        💬 WhatsApp Support
                                    </a>
                                </li>
                        ...
                        <div>
                            ...
                            <div className="footer-v2-contact">
                                ...
                                <div className="footer-v2-contact-item">
                                    <span className="footer-v2-contact-icon">📱</span>
                                    <a href="https://wa.me/919217945235">+91 92179 45235</a>
                                </div>
                                <div className="footer-v2-contact-item">
